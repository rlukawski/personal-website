...
import cubeCorporateReleaseLogo from "../assets/cube-corporate-release-logo.png";
...
const getExperienceData = (): ExperienceItem[] => [
  ...
  },
  {
    ...
    technologies:
      "Next.js, React, TypeScript, Zustand, tRPC, PostgreSQL, Docker, SCSS, Tailwind CSS",
  },
  {
    startDate: "2020.01",
    endDate: "2021.12",
  ...
  },
  {
    ...
    company: "CUBE Corporate Release",
    customIcon: cubeCorporateReleaseLogo,
    descriptionKeys: ["experience.exp4.desc0", "experience.exp4.desc1"],
  },
  {
    startDate: "2010.01",
    endDate: "2011.12",
  ...
  },
  {
    ...
    projectKey: "experience.exp7.project",
  },
  {
    startDate: "2000.01",
    endDate: "2007.05",
    ...
    company: "Onet.pl",
    customIcon: onetLogo,
    descriptionKeys: ["experience.exp8.desc0", "experience.exp8.desc1"],
