...
const experienceData = [
  {
    ...
    product: 'ExoClinic (software) on multiple devices used by EGZOTech for instance: Stella BIO, Sidra LEG, Meissa OT and more',
    technologies: 'React, Redux, Signals, Typescript, Cypress, Websocket, REST, Docker, CI/CD, MySQL',
  },
  {
    startDate: '2020.09',
    endDate: 'present',
    ...
    technologies: 'React, Zustand, TS/JS, Next.js, SCSS, PostgreSQL, Trpc, REST, Docker',
  },
  {
    startDate: '2013.01',
    endDate: '2016.10',
    ...
    technologies: 'PHP, CakePHP, MySQL, HTML/CSS, JS',
    product: 'https://multibenefit.pl',
  },
  {
    startDate: '2010.01',
    endDate: '2012.12',
  ...
  },
  {
    ...
    descriptions: [
      'Technical Product Manager for VoIP services in Poland',
    ],
          ...
          {experienceData.map((exp, index) => (
            <React.Fragment key={index}>
              ...
              <div>
                ...
                {(exp.descriptions.length > 0 || exp.technologies || exp.product) && (
